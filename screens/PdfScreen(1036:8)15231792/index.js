...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_1036_11} />
      <View style={styles.View_1036_12} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/14e3/8986/f623650a13446d57138ba167ca72ba9d"
        }}
        style={styles.ImageBackground_1036_13}
      />
      <View style={styles.View_1036_14}>
        <Text style={styles.Text_1036_14}>Forex Introduction</Text>
      </View>
      <View style={styles.View_1036_15}>
        <Text style={styles.Text_1036_15}>
          Course description Lorem ipsum dolor sit amet, consectetur adipiscing
          elit, sed do eiusmod tempor incididunt ut labore et dolore magna
          aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
        </Text>
      </View>
      <View style={styles.View_1036_16}>
        <Text style={styles.Text_1036_16}>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_1036_17}
      />
      <View style={styles.View_1036_18} />
      <View style={styles.View_1036_19}>
        <Text style={styles.Text_1036_19}>A</Text>
      </View>
      <View style={styles.View_1036_20}>
        <Text style={styles.Text_1036_20}>PDFs</Text>
      </View>
      <View style={styles.View_1036_21}>
        <View style={styles.View_1036_22} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/64af/1cc8/980672c1c092c182c1398d930a5eaa75"
          }}
          style={styles.ImageBackground_1036_23}
        />
      </View>
      <View style={styles.View_1036_24}>
        <View style={styles.View_1036_25} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2636/6621/5d41b8cee8df7cc20ba7018d09715d52"
          }}
          style={styles.ImageBackground_1036_26}
        />
      </View>
      <View style={styles.View_1036_27}>
        <View style={styles.View_1036_28} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/841e/0e77/96b701dbfb017f405ec316a0b98b3747"
          }}
          style={styles.ImageBackground_1036_29}
        />
      </View>
      <View source={{ uri: "null" }} style={styles.View_1036_30} />
      <View style={styles.View_1036_31}>
        <View style={styles.View_1036_32} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/4ed5/d043/1b64236727589b1c4e769c6423bf81ee"
          }}
          style={styles.ImageBackground_1036_33}
        />
      </View>
      <View style={styles.View_1036_34} />
      <View style={styles.View_1036_35}>
        <View style={styles.View_1036_36}>
          <View style={styles.View_1036_37} />
        </View>
        <View style={styles.View_1036_38}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/67ce/4bb5/25857e0c713544668f524a4f7518b7bf"
            }}
            style={styles.ImageBackground_1036_39}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1036_40}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1036_43}
          />
        </View>
        <View style={styles.View_1036_46}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/df7c/8f9e/6b781ac7185e888cbb03df7c0b8e641d"
            }}
            style={styles.ImageBackground_1036_47}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1036_48}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1036_51}
          />
        </View>
        <ImageBackground
          source={{
          ...
          style={styles.ImageBackground_1036_55}
        />
      </View>
      <View source={{ uri: "null" }} style={styles.View_1036_56} />
